...
class RegisterForm(FlaskForm):
    name = StringField('Name:', validators=[DataRequired("Please enter your name"), Regexp("^[A-Za-z ,.'-]+$", message="Name must contain only letters"),  Length(3, 30, message="Length must be between 3-30 characters")])
